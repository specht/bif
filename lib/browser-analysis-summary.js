    ...
    function render(state) {
        ...
        if (state.model) {
            ...
            if (state.model.contentHash !== renderedHash) {
                ...
                errors.replaceChildren(createIcon('x'), document.createTextNode(countLabel(model.summary.errors, 'error')));
                warnings.replaceChildren(createIcon('alert-triangle'), document.createTextNode(countLabel(model.summary.warnings, 'warning')));
                ...
                clean.replaceChildren(createIcon('check'), document.createTextNode('No problems'));
