...
const ICONS = ['alert-triangle', 'book-2', 'check', 'chevron-down', 'chevron-up', 'focus-2', 'hierarchy-2', 'refresh', 'x'];
const root = path.resolve(__dirname, '../..');
const sourceRoot = path.join(root, 'node_modules', '@tabler', 'icons', 'icons', 'outline');
const output = path.join(root, 'engine', 'runtime', 'assets', 'icons.svg');
