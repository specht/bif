// Pure JavaScript SHA-256 for authoring pages served from non-secure HTTP origins.
...
export function sha256Hex(input) {
    ...
    paddedView.setUint32(paddedLength - 8, Math.floor(bytes.length / 0x20000000), false);
    paddedView.setUint32(paddedLength - 4, (bytes.length << 3) >>> 0, false);
