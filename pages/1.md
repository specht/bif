---
title: Die List des Odysseus
---

<!-- Insel -- Start -->

![Titelbild](images/odysseus.jpg)
...
- [Ask whether he saw the suitcase.](.)
    ...
    > “A man carried it toward the front of the train.”

- [Ask what the man looked like.](.) { condition="knows_suitcase_went_forward" }

    <script>
    knows_porter_description = true;
    </script>

    > “Grey coat, red gloves, and a scar.”

- [Show Adler the photograph.](4) { condition="has_photograph" }

    <script>
    adler_confronted = true;
    </script>
